				...
				<div class="box-body">
					...
					{!! Form::open(array('class'=>'form-inline','name'=>'patient_form')) !!}
					 <div class="col-lg-4">
						...
						<div class="form-group">
							<a href="{{ url('admin/print') }}" target="_blank" class="btn btn-success @if(!Session::has('receiptionists') && !Session::has('receiptionist')) disabled @endif "><i class="fa fa-print"></i> طباعة التقرير </a>
							<div class="form-group">
